...
class Product(models.Model):
    created_user = models.ForeignKey(User, verbose_name="원작자", on_delete=models.CASCADE, related_name='product_create_user')
    owner_user = models.ForeignKey(User, verbose_name="소유자", on_delete=models.CASCADE, related_name='product_owner_user')
